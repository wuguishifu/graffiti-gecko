        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative w-20 flex items-center justify-center">
            <div className="absolute">
              <Timer remainingDurationSeconds={timeLeft} totalDurationSeconds={totalTime} size={64} strokeWidth={3} />
            </div>
          </div>
          <p className="font-blank-river text-3xl w-12">{secondsToTimeString(timeLeft)}</p>
        </div>
      </div>
    </div>
  );
